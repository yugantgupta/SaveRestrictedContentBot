...
# variables
API_ID = config("API_ID", "22233521", default=None, cast=int)
API_HASH = config("API_HASH", "dfad40fe3665377983903737cc05cfbc", default=None)
BOT_TOKEN = config("BOT_TOKEN", "8736368440:AAGqGxVFBSE1RX2TXTIHYhKMdYc6si0iOGY",default=None)
...
FORCESUB = config("FORCESUB", "saverest091",default=None)
AUTH = config("AUTH", "5298157466",default=None, cast=int)
